    ...
    def __init__(self, master):
        ...
        def Insert():
            if (len(self.admsn.get()) != 0):
                Fee_Backend.insert(self.recpt.get(), self.name.get(), self.admsn.get(), datetime.date.today(),
                                   self.branch.get(), self.sem.get(), self.total.get(), self.paid.get(),
                                   self.total.get() - self.paid.get())    
                due = self.total.get() - self.paid.get()
                self.list.delete(0, END)
                self.list.insert(END, (self.recpt.get(), self.name.get(), self.admsn.get(), datetime.date.today(),
                                       self.branch.get(), self.sem.get(), self.total.get(), self.paid.get(),
                                       due))
        ...
        def Search():
            ...
            for row in Fee_Backend.search(self.recpt.get(), self.name.get(), self.admsn.get(), self.date.get(),
                                          self.branch.get(), self.sem.get()):
                self.list.insert(END, row, str(' '))

        def Update():
            #Fee_Backend.delete(st[0])
            #Insert()
            Fee_Backend.update(st[0],self.recpt.get(), self.name.get(), self.admsn.get(), self.date.get(),
                                   self.branch.get(), self.sem.get(), self.total.get(), self.paid.get(),
                                   self.total.get()-self.paid.get())
            self.list.delete(0, END)
        ...
        # ==================================================Entries=================================================
        #self.var_1 = DoubleVar(Frame_1, value='')
        d1 = datetime.date.today()
        self.date.set(d1)
        self.due.set(self.total.get() - self.paid.get())
        ...
        self.Date_entry = Entry(Frame_1, font=(
            'arial', 14), textvariable=self.date, state='readonly')
