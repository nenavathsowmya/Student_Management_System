       ...
       def __init__(self, master):
              ...
              #========================================================Variables=====================================================================
               ...
               #==========================================================Functions====================================================================
                     ...
                     def Delete():
                            if(len(self.name.get()) != 0):
                               #messagebox.showinfo("name", selected_tuple[0])
                     ...
                     def Update():
                                   ...
                                   #Std_info_BackEnd.delete(selected_tuple[0])
                            if(len(self.name.get()) != 0):
                                   #messagebox.showinfo("id",selected_tuple[0])
                                   self.id = selected_tuple[0]
                                   #print(self.id)
                                   #Std_info_BackEnd.insert(self.name.get(), self.fname.get(), self.mname.get(), self.address.get(), self.mobno.get(), self.email.get(), self.dob.get(), \
                                                       #self.gender.get())
                                   Std_info_BackEnd.update(self.id,self.name.get(), self.fname.get(), self.mname.get(), self.address.get(), self.mobno.get(), self.email.get(), self.dob.get(), self.gender.get())
                                   self.listbox.delete(0, END)
                                   self.listbox.insert(END, (self.name.get(), self.fname.get(), self.mname.get(), self.address.get(), self.mobno.get(), self.email.get(), self.dob.get(), self.gender.get()))
