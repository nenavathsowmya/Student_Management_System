...
def __information__():
       ...
       subprocess.run(["python", "Std_info_FrontEnd.py"])
       #os.system(filename)
       #os.system(filename)

def __FeeReport__():
       filename = 'Fee_Frontend.py'
       subprocess.run(["python", "Fee_Frontend.py"])
       #os.system(filename)
...
def menu():
       ...
       title_Label = Label(title_Frame, text = 'Student Management System', font = ('arial',30,'bold'), bg = 'lightblue')
